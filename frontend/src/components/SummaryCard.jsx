    ...
    <div className="neo-card" style={{ padding: '30px', background: '#FFFDF6' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
        <div>
          ...
          <h2 style={{ fontFamily: 'Space Grotesk', fontSize: '1.8rem', marginTop: '5px' }}>
      ...
      {summary.red_flags && summary.red_flags.length > 0 && (
        <div style={{
          ...
          <h4 style={{ color: '#D90429', fontFamily: 'Space Grotesk', fontSize: '1.1rem' }}>
            🚨 RED FLAGS DETECTED
          </h4>
      ...
      <div style={{ border: '2px solid #000', padding: '15px', borderRadius: '8px', marginBottom: '15px', background: '#FFF' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <h4 style={{ fontFamily: 'Space Grotesk', fontSize: '1.2rem' }}>1. Current Complaints & SOCRATES Probing</h4>
      ...
      <div style={{ border: '2px solid #000', padding: '15px', borderRadius: '8px', marginBottom: '15px', background: '#FFF' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <h4 style={{ fontFamily: 'Space Grotesk', fontSize: '1.2rem' }}>2. AYUSH Dashavidha Pariksha Profile</h4>
      ...
      <div style={{ border: '2px solid #000', padding: '15px', borderRadius: '8px', marginBottom: '15px', background: '#FFF' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <h4 style={{ fontFamily: 'Space Grotesk', fontSize: '1.2rem' }}>3. Extracted Medications & OCR Findings</h4>
      ...
      <div style={{ border: '2px solid #000', padding: '15px', borderRadius: '8px', background: '#FFF' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <h4 style={{ fontFamily: 'Space Grotesk', fontSize: '1.2rem' }}>4. Reported Allergies & Conflicts</h4>
